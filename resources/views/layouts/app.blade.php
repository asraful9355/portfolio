...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
     @php
      ...
      @foreach($posts as $post)
        <link rel="shortcut icon" href="{{asset($post->featured) }}" type="image/x-icon">
      @endforeach
...
<div class="wrapper">
 ...
 @php
 $bye = App\Models\By::latest()->get();
 @endphp
  <!-- /.content-wrapper -->
  <footer class="main-footer">
    @foreach($bye as $by )
    <strong>Copyright &copy; 2022 <a href="{{ $by->link }}">{{$by->name }}</a>.</strong>
    @endforeach
    All rights reserved.
